  ...
  return (
    <div className="fixed inset-0 z-[100] bg-transparent flex flex-col items-center justify-center overflow-hidden selection:bg-violet-500/30">
      ...
      >
        ...
        <button 
          onClick={() => goToAuth()}
          className="group relative px-8 py-4 bg-transparent overflow-hidden rounded-full border border-white/10 hover:border-white/30 transition-colors duration-200"
        >
          <div className="absolute inset-0 bg-white/5 translate-y-[100%] group-hover:translate-y-0 transition-transform duration-200 ease-out" />
