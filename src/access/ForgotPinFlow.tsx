            ...
            <div className="glass-panel border border-white/5 rounded-3xl p-8 shadow-2xl relative overflow-hidden ">
              ...
              <div className="flex gap-4">
                ...
                <button 
                  ...
                  className="flex-1 py-3 rounded-xl font-semibold glass-button text-white border-transparent hover:border-violet-500/50 disabled:bg-white/5 disabled:text-gray-500 transition-colors"
                >
                  Verify
                </button>
              </div>
          ...
          >
            <div className="glass-panel border border-white/5 rounded-3xl p-8 shadow-2xl relative overflow-hidden ">
              ...
              <div className="space-y-6">
                ...
                <div className={`transition-opacity duration-150 ${newPin.length === 6 ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
                ...
                <button 
                   ...
                   onClick={handleReset}
                   className="w-full py-3 mt-4 rounded-xl font-semibold glass-button text-white border-transparent hover:border-violet-500/50 disabled:bg-white/5 disabled:text-gray-500 transition-colors"
                >
                  Reset & Enter
                </button>
              </div>
