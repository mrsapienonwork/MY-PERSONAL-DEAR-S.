        ...
        <div className="glass-panel border border-white/5 rounded-2xl p-5 md:p-8 shadow-sm">
           ...
           <div className="space-y-6">
              ...
              <div className="flex gap-4 pt-4">
                 <button 
                 onClick={clearState}
                 className="flex-1 py-3 rounded-xl border border-white/10 text-white hover:bg-white/5 transition-colors text-sm font-semibold"
                 >
                 Cancel
                 </button>
                 <button 
                 ...
                 className="flex-1 py-3 rounded-xl glass-button text-white border-transparent hover:border-violet-500/50 disabled:bg-white/10 disabled:text-gray-500 transition-colors text-sm font-semibold"
                 >
                 Confirm
                 </button>
              </div>
