        ...
        <div className="glass-panel border border-white/5 rounded-3xl p-8 shadow-2xl relative overflow-hidden ">
          ...
          <div className="space-y-6">
            ...
            <button 
              ...
              onClick={handleEnter}
              className="w-full py-3 mt-2 rounded-xl font-semibold glass-button text-white border-transparent hover:border-violet-500/50 disabled:bg-white/5 disabled:text-gray-500 transition-colors"
            >
              Enter System
            </button>
