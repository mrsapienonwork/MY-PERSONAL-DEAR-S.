...
export function CapturePanel({ onClose }: { onClose: () => void }) {
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, x: 20 }}
      className="flex flex-col h-full bg-black/80 sm:bg-black/60 border border-white/10 rounded-2xl overflow-hidden shadow-2xl"
    >
            ...
            <div className="space-y-4 bg-white/[0.02] p-4 rounded-xl border border-white/5">
              <div>
                ...
                <select 
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-lg p-2.5 text-white focus:outline-none focus:border-violet-500 focus:ring-1 focus:ring-violet-500 transition-colors"
                  required
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-lg p-2.5 text-white placeholder-gray-600 focus:outline-none focus:border-violet-500 transition-colors"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 bg-white/[0.02] p-4 rounded-xl border border-white/5">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-lg p-2.5 text-white placeholder-gray-600 focus:outline-none focus:border-rose-500 transition-colors"
                  required
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <select 
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-lg p-2.5 text-white focus:outline-none focus:border-rose-500 transition-colors"
                  >
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-lg p-3 text-white placeholder-gray-600 focus:outline-none focus:border-rose-500 transition-colors min-h-[80px]"
                />
              </div>
            </div>
          </section>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea 
                    ...
                    className="w-full pl-10 bg-white/5 border border-white/10 rounded-lg p-3 text-white placeholder-gray-600 focus:outline-none focus:border-emerald-500 transition-colors min-h-[80px]"
                  />
                </div>
              </div>
      ...
      <div className="p-4 sm:p-6 border-t border-white/5 flex flex-col-reverse sm:flex-row sm:justify-end gap-3 bg-black/40">
        <button
          type="button"
          onClick={onClose}
          className="w-full sm:w-auto px-5 py-2.5 rounded-lg font-medium text-gray-300 hover:text-white bg-white/5 sm:bg-transparent hover:bg-white/10 sm:hover:bg-white/5 transition-colors flex items-center justify-center"
        >
          Cancel
        </button>
        <button
          ...
          className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-2.5 bg-violet-600 hover:bg-violet-500 text-white rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed "
        >
