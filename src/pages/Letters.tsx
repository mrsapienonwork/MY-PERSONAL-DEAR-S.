...
const glassCardClasses = "bg-[rgba(255,255,255,0.06)]  border border-[rgba(255,255,255,0.1)] shadow-lg rounded-2xl md:rounded-3xl";
const glassButtonClasses = "bg-[rgba(255,255,255,0.08)]  border border-[rgba(255,255,255,0.15)] hover:bg-[rgba(255,255,255,0.12)] hover:border-[rgba(255,255,255,0.25)] transition-colors duration-150 text-white rounded-xl";
          ...
          >
            ...
            {letters.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 px-2 pb-12">
                  {filteredLetters.slice(0, 30).map((letter) => (
                    <div 
                      key={letter.id} 
                      onClick={() => openLetter(letter.id)}
                      className={cn(
                        glassCardClasses,
                        "p-6 cursor-pointer group transition-colors duration-150 hover:-translate-y-[2px] hover:shadow-lg hover:border-white/20 hover:bg-[rgba(255,255,255,0.08)] animate-in fade-in slide-in-from-bottom-2 duration-150"
                      )}
                    >
            ...
            <div className={cn(glassCardClasses, "p-6 md:p-10 space-y-8")}>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {(['future', 'reality', 'support'] as const).map((type) => (
                    <button
                      ...
                      className={cn(
                        "py-3 px-2 rounded-xl text-sm font-medium transition-colors border flex items-center justify-center text-center",
                        newType === type 
                          ? getBadgeColor(type) 
              ...
              <div className="space-y-4">
                ...
                <textarea
                  ...
                  className="w-full h-64 bg-black/20 border border-white/5 rounded-2xl p-6 text-lg text-white/90 leading-relaxed placeholder:text-white/20 focus:outline-none focus:ring-1 focus:ring-white/20 focus:border-white/20 resize-none transition-colors"
                />
              </div>
              ...
              <button
                ...
                className={cn(
                  "w-full py-4 rounded-xl font-semibold tracking-wide transition-colors shadow-sm",
                  newText.trim() 
                    ? "bg-white text-black hover:bg-gray-200 hover:shadow-lg hover:scale-[1.01]" 
            ...
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="p-2.5 rounded-full bg-rose-500/10 border border-rose-500/20 text-rose-400 hover:bg-rose-500/20 hover:text-rose-300 transition-colors"
                >
                  <Trash2 size={16} />
                </button>
              </div>
