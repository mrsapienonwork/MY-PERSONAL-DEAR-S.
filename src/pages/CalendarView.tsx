        ...
        {monthDays.map(day => {
          ...
          return (
            <div 
              ...
              className={`min-h-[80px] sm:min-h-[96px] md:min-h-[128px] rounded-xl border p-1.5 sm:p-2 flex flex-col justify-between cursor-pointer transition-colors duration-150 shadow-sm hover:scale-[1.02] hover:bg-white/[0.04] active:scale-95 ${bgClass} ${borderClass} ${todayBorder}`}
            >
              ...
              <div className="flex flex-col w-full text-right mt-auto">
                 {hasData && score ? (
                     <div className={`text-[10px] sm:text-xs md:text-sm font-mono font-bold tracking-tight rounded px-1.5 py-0.5 w-fit ml-auto outline outline-1 outline-white/10 ${
